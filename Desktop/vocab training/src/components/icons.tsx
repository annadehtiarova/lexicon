...
export function ListChecksIcon({ className = base }: IconProps) {
  return (
    <svg
      viewBox="0 0 24 24"
      fill="none"
      ...
      className={className}
    >
      <path d="M3.5 6.5l1.5 1.5 3-3M3.5 12.5l1.5 1.5 3-3M9 6h11M9 12h11M9 18h11" />
    </svg>
  );
}

export function KeyboardIcon({ className = base }: IconProps) {
  return (
    <svg
      viewBox="0 0 24 24"
      fill="none"
...
export function ColumnsIcon({ className = base }: IconProps) {
  return (
    <svg
      ...
      className={className}
    >
      <rect x="3" y="4" width="8" height="16" rx="1.5" strokeDasharray="3 3" />
...
export function CameraIcon({ className = base }: IconProps) {
  return (
    <svg
      ...
      className={className}
    >
      <path d="M4 7h2.5l1.2-2h8.6l1.2 2H20a1 1 0 0 1 1 1v10a1 1 0 0 1-1 1H4a1 1 0 0 1-1-1V8a1 1 0 0 1 1-1Z" />
      <circle cx="12" cy="13" r="3.2" />
    </svg>
  );
}

export function ImagePlusIcon({ className = base }: IconProps) {
  return (
    <svg
      viewBox="0 0 24 24"
      fill="none"
...
export function BookOpenIcon({ className = base }: IconProps) {
  return (
    <svg
      ...
      className={className}
    >
      <path d="M12 6.5c-1.6-1.2-3.7-1.7-6-1.7v13c2.3 0 4.4.5 6 1.7 1.6-1.2 3.7-1.7 6-1.7v-13c-2.3 0-4.4.5-6 1.7Z" />
      <path d="M12 6.5v13" />
    </svg>
  );
}

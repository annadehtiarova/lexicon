...
function StudySetClient({ id }) {
    ...
    const handleMastered = (wordId)=>{
        setMasteredIds((prev)=>{
            ...
            if (set.isPersisted) {
                (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$storage$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["setMasteredWordIds"])(id, Array.from(next));
            }
            return next;
        });
    };
...
_s(StudySetClient, "9jgV2gl+/YzlmTetkErwReTwMZQ=");
_c = StudySetClient;
var _c;
...
;
;
function CardsMode({ words, masteredIds, onMastered }) {
    _s();

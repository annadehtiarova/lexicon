...
"[project]/node_modules/onnxruntime-web/dist/ort-wasm-simd-threaded.asyncify.wasm (static in ecmascript, tag client)", ((__turbopack_context__) => {

__turbopack_context__.q("/_next/static/media/ort-wasm-simd-threaded.asyncify.0phdreyubz4lg.wasm");}),
"[project]/node_modules/onnxruntime-web/dist/ort.webgpu.bundle.min.mjs (static in ecmascript, tag client)", ((__turbopack_context__) => {

__turbopack_context__.q("/_next/static/media/ort.webgpu.bundle.min.2gtd6ccrqc86p.mjs");}),
...
var __TURBOPACK__import$2e$meta__ = {
    get url () {
        return __turbopack_context__.F("node_modules/onnxruntime-web/dist/ort.webgpu.bundle.min.mjs");
    },
    env: {
        DEV: true,
        PROD: false,
...
/*!
 * ONNX Runtime Web v1.31.0-dev.20260914-8d85527a0
...
var Xr = ((a1)=>("TURBOPACK compile-time value", "function") < "u" ? /*TURBOPACK member replacement*/ __turbopack_context__.z : typeof Proxy < "u" ? new Proxy(a1, {
        get: (r, s)=>(("TURBOPACK compile-time value", "function") < "u" ? /*TURBOPACK member replacement*/ __turbopack_context__.z : r)[s]
    }) : a1)(function(a1) {
...
var At = (a1, r)=>{
    for(var s in r)Jr(a1, s, {
        get: r[s],
        enumerable: !0
    });
}, mc = (a1, r, s, f)=>{
    if (r && typeof r == "object" || typeof r == "function") for (let i of lc(r))!pc.call(a1, i) && i !== s && Jr(a1, i, {
        get: ()=>r[i],
        enumerable: !(f = dc(r, i)) || f.enumerable
    });
    return a1;
};
var Ht = (a1)=>mc(Jr({}, "__esModule", {
        value: !0
    }), a1);
var qt, tt, rt, hc, Da, Zr = G(()=>{
    "use strict";
    qt = new Map, tt = [], rt = (a1, r, s)=>{
        if (r && typeof r.init == "function" && typeof r.createInferenceSessionHandler == "function") {
            let f = qt.get(a1);
            if (f === void 0) qt.set(a1, {
                backend: r,
                priority: s
            });
            else {
                if (f.priority > s) return;
                if (f.priority === s && f.backend !== r) throw new Error(`cannot register backend "${a1}" using priority ${s}`);
            }
            if (s >= 0) {
                let i = tt.indexOf(a1);
                i !== -1 && tt.splice(i, 1);
        ...
        if (r.aborted) return r.error;
        {
            let s = !!r.initPromise;
            try {
                return s || (r.initPromise = r.backend.init(a1)), await r.initPromise, r.initialized = !0, r.backend;
            } catch (f) {
        ...
        let r = a1.executionProviders || [], s = r.map((g)=>typeof g == "string" ? g : g.name), f = s.length === 0 ? tt : s, i, p = [], l = new Set;
        for (let g of f){
            let w = await hc(g);
            typeof w == "string" ? p.push({
                name: g,
                err: w
            }) : (i || (i = w), i === w && l.add(g));
        }
        ...
        return [
            i,
            new Proxy(a1, {
                get: (g, w)=>w === "executionProviders" ? b : Reflect.get(g, w)
            })
        ];
    };
});
...
var Ua, _a = G(()=>{
    "use strict";
    Ua = "1.31.0-dev.20260911-2a43ec07e";
});
var Ra, ie, Kr = G(()=>{
    "use strict";
    _a();
    ...
    Object.defineProperty(ie, "logLevel", {
        enumerable: !0
    });
});
var ee, Na = G(()=>{
...
var Wa, ka, Fa = G(()=>{
    ...
    Wa = (a1, r)=>{
        ...
        if (f != null) {
            let i, p;
            r?.tensorLayout !== void 0 && r.tensorLayout === "NHWC" ? (i = a1.dims[2], p = a1.dims[3]) : (i = a1.dims[3], p = a1.dims[2]);
            let l = r?.format !== void 0 ? r.format : "RGB", b = r?.norm, g, w;
            b === void 0 || b.mean === void 0 ? g = [
                255,
                255,
                255,
                255
            ] : typeof b.mean == "number" ? g = [
                b.mean,
                b.mean,
                b.mean,
                b.mean
                ...
                b.mean[2],
                0
            ], b.mean[3] !== void 0 && (g[3] = b.mean[3])), b === void 0 || b.bias === void 0 ? w = [
                0,
                0,
                0,
                0
            ] : typeof b.bias == "number" ? w = [
                b.bias,
                b.bias,
                b.bias,
                b.bias
            ...
            for(let _ = 0; _ < p; _++)for(let k = 0; k < i; k++){
                let U = (a1.data[v++] - w[0]) * g[0], M = (a1.data[T++] - w[1]) * g[1], Y = (a1.data[A++] - w[2]) * g[2], O = C === -1 ? 255 : (a1.data[C++] - w[3]) * g[3];
        ...
        if (s != null) {
            let i, p, l;
            r?.tensorLayout !== void 0 && r.tensorLayout === "NHWC" ? (i = a1.dims[2], p = a1.dims[1], l = a1.dims[3]) : (i = a1.dims[3], p = a1.dims[2], l = a1.dims[1]);
            let b = r !== void 0 && r.format !== void 0 ? r.format : "RGB", g = r?.norm, w, S;
            g === void 0 || g.mean === void 0 ? w = [
                255,
                255,
                255,
                255
            ] : typeof g.mean == "number" ? w = [
                g.mean,
                g.mean,
                g.mean,
                g.mean
                ...
                g.mean[2],
                255
            ], g.mean[3] !== void 0 && (w[3] = g.mean[3])), g === void 0 || g.bias === void 0 ? S = [
                0,
                0,
                0,
                0
            ] : typeof g.bias == "number" ? S = [
                g.bias,
                g.bias,
                g.bias,
                g.bias
            ...
            for(let $ = 0; $ < p * i; A += T, C += T, _ += T, k += T, $++)f.data[A] = (a1.data[U++] - S[0]) * w[0], f.data[C] = (a1.data[M++] - S[1]) * w[1], f.data[_] = (a1.data[Y++] - S[2]) * w[2], f.data[k] = O === -1 ? 255 : (a1.data[O++] - S[3]) * w[3];
        } else throw new Error("Can not access image data");
        return f;
    };
});
var Qr, Ga, $a, za, Va, ja, Ha = G(()=>{
    "use strict";
    Yt();
    Qr = (a1, r)=>{
        ...
        let { height: s, width: f } = r, i = r.norm ?? {
            mean: 255,
            bias: 0
        }, p, l;
        typeof i.mean == "number" ? p = [
            i.mean,
            i.mean,
            i.mean,
            i.mean
        ...
        for(let $ = 0; $ < w; $++, T += v, C += v, A += v, _ += v)S[k++] = (a1[T] + l[0]) / p[0], S[U++] = (a1[A] + l[1]) / p[1], S[M++] = (a1[C] + l[2]) / p[2], Y !== -1 && _ !== -1 && (S[Y++] = (a1[_] + l[3]) / p[3]);
        return g === "RGBA" ? new ce("float32", S, [
            1,
            4,
            s,
            f
        ...
        let s = typeof HTMLImageElement < "u" && a1 instanceof HTMLImageElement, f = typeof ImageData < "u" && a1 instanceof ImageData, i = typeof ImageBitmap < "u" && a1 instanceof ImageBitmap, p = typeof a1 == "string", l, b = r ?? {}, g = ()=>{
        ...
        if (s) {
            let S = g();
            S.width = a1.width, S.height = a1.height;
            let v = w(S);
            if (v != null) {
                let T = a1.height, A = a1.width;
                ...
                v.drawImage(a1, 0, 0), l = v.getImageData(0, 0, A, T).data;
            } else throw new Error("Can not access image data");
        } else if (f) {
            let S, v;
            if (r !== void 0 && r.resizedWidth !== void 0 && r.resizedHeight !== void 0 ? (S = r.resizedHeight, v = r.resizedWidth) : (S = a1.height, v = a1.width), r !== void 0 && (b = r), b.format = "RGBA", b.height = S, b.width = v, r !== void 0) {
                let T = g();
                T.width = v, T.height = S;
                let A = w(T);
                if (A != null) A.putImageData(a1, 0, 0), l = A.getImageData(0, 0, v, S).data;
                else throw new Error("Can not access image data");
            } else l = a1.data;
        } else if (i) {
            ...
            if (v != null) {
                let T = a1.height, A = a1.width;
                return v.drawImage(a1, 0, 0, A, T), l = v.getImageData(0, 0, A, T).data, b.height = T, b.width = A, Qr(l, b);
            } else throw new Error("Can not access image data");
        } else {
            if (p) return new Promise((S, v)=>{
                ...
                if (!a1 || !A) return v();
                let C = new Image;
                C.crossOrigin = "Anonymous", C.src = a1, C.onload = ()=>{
        ...
        let { width: s, height: f, download: i, dispose: p } = r, l = [
            1,
            f,
            s,
            4
...
var nt, It, qa, Ya, Ja = G(()=>{
    ...
    nt = new Map([
        ...
        if (!qa) {
            qa = !0;
            let a1 = typeof BigInt64Array < "u" && BigInt64Array.from, r = typeof BigUint64Array < "u" && BigUint64Array.from, s = globalThis.Float16Array, f = typeof s < "u" && s.from;
            a1 && (nt.set("int64", BigInt64Array), It.set(BigInt64Array, "int64")), r && (nt.set("uint64", BigUint64Array), It.set(BigUint64Array, "uint64")), f ? (nt.set("float16", s), It.set(s, "float16")) : nt.set("float16", Uint16Array);
        }
    };
});
var Xa, Za, Ka = G(()=>{
    ...
    Xa = (a1)=>{
        ...
        switch(a1.location){
            case "cpu":
                return new ce(a1.type, a1.data, r);
            case "cpu-pinned":
                return new ce({
                    location: "cpu-pinned",
                    data: a1.data,
...
var Qa, es, ot, at, $e, ze, tn = G(()=>{
    "use strict";
    Kr();
    Qa = (a1, r)=>{
        (typeof ie.trace > "u" ? !ie.wasm.trace : !ie.trace) || console.timeStamp(`${a1}::ORT::${r}`);
    }, es = (a1, r)=>{
        let s = new Error().stack?.split(/\r\n|\r|\n/g) || [], f = !1;
        for(let i = 0; i < s.length; i++){
            if (f && !s[i].includes("TRACE_FUNC")) {
                let p = `FUNC_${a1}::${s[i].trim().split(" ")[1]}`;
                r && (p += `::${r}`), Qa("CPU", p);
                return;
            }
        ...
        (typeof ie.trace > "u" ? !ie.wasm.trace : !ie.trace) || es("BEGIN", a1);
    }, at = (a1)=>{
        (typeof ie.trace > "u" ? !ie.wasm.trace : !ie.trace) || es("END", a1);
    }, $e = (a1)=>{
        (typeof ie.trace > "u" ? !ie.wasm.trace : !ie.trace) || console.time(`ORT::${a1}`);
    }, ze = (a1)=>{
        (typeof ie.trace > "u" ? !ie.wasm.trace : !ie.trace) || console.timeEnd(`ORT::${a1}`);
    };
});
var Jt, ts = G(()=>{
    "use strict";
        ...
        async run(r, s, f) {
            ...
            if (typeof s == "object") {
                ...
                if (Array.isArray(s)) {
                    ...
                    let w = !1, S = Object.getOwnPropertyNames(s);
                    for (let v of this.outputNames)if (S.indexOf(v) !== -1) {
                        let T = s[v];
                        (T === null || T instanceof Le) && (w = !0, l = !1, i[v] = T);
                    }
                    if (w) {
                        if (typeof f == "object" && f !== null) p = f;
                        else if (typeof f < "u") throw new TypeError("'options' must be an object.");
            ...
            return ze("InferenceSession.run"), at(), g;
        }
        async release() {
            return this.handler.dispose();
        }
        static async create(r, s, f, i) {
            ot(), $e("InferenceSession.create");
            let p, l = {};
            if (typeof r == "string") {
            ...
            return ze("InferenceSession.create"), at(), new a1(w);
        }
        startProfiling() {
...
var us, fs, gc, ds = G(()=>{
    ...
    fs && (self.onmessage = (a1)=>{
        let { type: r, in: s } = a1.data;
        try {
            switch(r){
                case "init-wasm":
                    Kt(s.wasm).then(()=>{
    ...
    gc = fs ? null : (a1)=>new Worker(a1 ?? ye, {
            type: "module",
            name: us
        });
});
...
async function ls(a1 = {}) {
    var r = a1, s = !!globalThis.window, f = !!globalThis.WorkerGlobalScope, i = f && self.name?.startsWith("em-pthread");
    r.mountExternalData = (e, t)=>{
        e.startsWith("./") && (e = e.substring(2)), (r.ed || (r.ed = new Map)).set(e, t);
    ...
    var l, b, g = (e, t)=>{
        throw t;
    }, w = __TURBOPACK__import$2e$meta__.url, S = "";
    if (s || f) {
        try {
            S = new URL(".", w).href;
        } catch  {}
    ...
    var v, T, A, C, _, k, U = console.log.bind(console), M = console.error.bind(console), Y = U, O = M, $ = !1, oe = (e)=>e.startsWith("file://");
    function d() {
        Fe.buffer != Z.buffer && se();
    }
    if (i) {
        let e = function(t) {
            try {
                ...
                if (o === "load") {
                    ...
                    Fe = n.Me, se(), T = n.Ne, wt(), jt();
                } else if (o === "run") {
                    (function(u) {
                        var c = (d(), E)[u + 52 >>> 2 >>> 0];
                        u = (d(), E)[u + 56 >>> 2 >>> 0], Fo(c, c - u), D(c);
                    })(n.Xc), zr(n.Xc, 0, 0, 1, 0, 0), wn(), Br(n.Xc), te || (vo(), te = !0);
                    try {
                        ei(n.ze, n.kd);
                    } catch (u) {
                        if (u != "unwind") throw u;
    ...
    var Z, X, De, K, I, E, R, ae, pe, J, ge, ne = !1;
    function se() {
        var e = Fe.buffer;
    ...
    function we(e) {
        throw O(e = "Aborted(" + e + ")"), $ = !0, e = new WebAssembly.RuntimeError(e + ". Build with -sASSERTIONS for more info."), _?.(e), e;
    }
    function qe() {
        return {
            a: {
    ...
    async function wt() {
        function e(o, u) {
            ...
            return Ne = o, Ne = function() {
                ...
                return (h = Object.assign({}, h)).ic = m(h.ic), h.Nc = y(h.Nc), h.Pc = m(h.Pc), h.Bd = ((x)=>(N, F)=>x(N, F) >>> 0)(h.Bd), h.Gd = m(h.Gd), h.Hd = y(h.Hd), h.Ld = m(h.Ld), h;
        ...
        }) : i ? e(new WebAssembly.Instance(T, qe()), T) : (ge ??= r.locateFile ? r.locateFile ? r.locateFile("ort-wasm-simd-threaded.asyncify.wasm", S) : S + "ort-wasm-simd-threaded.asyncify.wasm" : new __turbopack_context__.U(__turbopack_context__.r("[project]/node_modules/onnxruntime-web/dist/ort-wasm-simd-threaded.asyncify.wasm (static in ecmascript, tag client)")).href, t = await async function(o) {
            var u = ge;
            if (!v && !oe(u)) try {
                var c = fetch(u, {
                    credentials: "same-origin"
    ...
    var vr = (e)=>{
        ...
        var t = e.Xc;
        delete Je[t], ke.push(e), vt.splice(vt.indexOf(e), 1), e.Xc = 0, No(t);
    };
    function wn() {
        gn.forEach((e)=>e());
    }
    var Tn = (e)=>new Promise((t)=>{
            e.onmessage = (u)=>{
                ...
                if (u = c.$c, c.gd && c.gd != zt()) {
                    ...
                    yn(Je[c.Le]);
                }) : u === "loaded" ? (e.loaded = !0, t(e)) : c.target === "setimmediate" ? e.postMessage(c) : u === "uncaughtException" ? e.onerror(c.error) : u === "callHandler" ? r[c.te](...c.args) : u && O(`worker sent an unknown command ${u}`);
            }, e.onerror = (u)=>{
    ...
    function vn() {
        var e = new Worker((()=>{
            let t = URL;
            return __TURBOPACK__import$2e$meta__.url > "file:" && __TURBOPACK__import$2e$meta__.url < "file;" ? new __turbopack_context__.U(__turbopack_context__.r("[project]/node_modules/onnxruntime-web/dist/ort.webgpu.bundle.min.mjs (static in ecmascript, tag client)")) : new URL(__TURBOPACK__import$2e$meta__.url);
        })(), {
            type: "module",
    ...
    function ti(e) {
        var t = new Er(e >>>= 0);
        return (d(), Z)[t.ad + 12 >>> 0] == 0 && (En(t, !0), Ut--), Sn(t, !1), Pt.push(t), zo(e);
    }
    var dt = 0, ri = ()=>{
        W(0, 0);
        var e = Pt.pop();
    ...
    var si = ()=>{
        ...
        var t = e.td;
        throw (d(), Z)[e.ad + 13 >>> 0] == 0 && (Pt.push(e), Sn(e, !0), En(e, !1), Ut++), Hr(t), dt = t;
    };
    function ii(e, t, n) {
        var o = new Er(e >>>= 0);
    ...
    function An(e, t, n, o) {
        ...
        var u = [];
        return i && u.length === 0 ? xn(e, t, n, o) : (e = {
            ye: n,
            Xc: e,
            kd: o,
            oe: u
        }, i ? (e.$c = "spawnThread", postMessage(e, u), 0) : Q(e));
    }
    function fi(e) {
        throw dt ||= e >>> 0, dt;
    }
    ...
    function li(e, t, n, o, u) {
        ...
        Pe(e, {
            name: t,
            Wc: c,
            cd: (h, m)=>(typeof m == "number" && (m = BigInt(m)), m),
            bd: $n(t, n, !o),
            dd: null
        });
    }
    ...
    function Ci(e, t) {
        (e >>>= 0) == t >>> 0 ? setTimeout(_t) : i ? postMessage({
            gd: e,
            $c: "checkMailbox"
        }) : (e = Je[e]) && e.postMessage({
            $c: "checkMailbox"
        });
    }
    var Or = [];
    ...
    function Ri(e) {
        var t = (...n)=>{
            ...
            try {
                ...
                $ || (Nt.pop(), Me && Ge === 1 && Nt.length === 0 && (Ge = 0, z += 1, Rt(Oa), typeof Fibers < "u" && Fibers.We()));
            }
        };
        return qn.set(e, t), t;
    }
    var Ge = 0, Me = null, jn = 0, Nt = [], Mr = new Map, Hn = new Map, qn = new Map, Ni = 0, Cr = null, Wi = [], Yn = (e)=>(function(t) {
            if (!$) {
                if (Ge === 0) {
                    var n = !1, o = !1;
                    t((u = 0)=>{
                        if (!$ && (jn = u, n = !0, o)) {
                            Ge = 2, Rt(()=>Ma(Me)), typeof MainLoop < "u" && MainLoop.se && MainLoop.resume(), u = !1;
                            try {
                                var c = function() {
                                    var y = (d(), I)[Me + 8 >>> 2 >>> 0];
                            ...
                            if (!Me) {
                                var m = Cr;
                                m && (Cr = null, (u ? m.reject : m.resolve)(c), h = !0);
                            }
                            if (u && !h) throw c;
                        }
                ...
                } else Ge === 2 ? (Ge = 0, Rt(Ca), ve(Me), Me = null, Wi.forEach(me)) : we(`invalid state: ${Ge}`);
                return jn;
            }
        })((t)=>{
            e().then(t);
  ...
  ${m}
  }`, n = new Function(Object.keys(h), m)(...Object.values(h)), m = `methodCaller<(${u.map((y)=>y.name)}) => ${o.name}>`, Fi(Object.defineProperty(n, "name", {
            value: m
        }));
    }
    function ji(e, t) {
    ...
    var Xn = (e)=>e % 4 == 0 && (e % 100 != 0 || e % 400 == 0), Zn = [
        0,
        31,
        60,
        91,
...
`))[0] == "Error" && o.shift(), oo(o);
    ...
    var Ce = (e)=>{
        ...
        $t(t + 4, n, o), n += o, o = _e(e.architecture), $t(t + 12, n, o), n += o, o = _e(e.device), $t(t + 20, n, o), n += o, o = _e(e.description), $t(t + 28, n, o), n += o, (d(), I)[t + 36 >>> 2 >>> 0] = 2, n = e.isFallbackAdapter ? 3 : 4, (d(), I)[t + 40 >>> 2 >>> 0] = n, (d(), E)[t + 44 >>> 2 >>> 0] = 0, (d(), E)[t + 48 >>> 2 >>> 0] = 0, Ur(t, {
            327739: (u)=>{
                let c = 0, h = 0;
    ...
    function zu(e, t, n) {
        ...
        t = {
            label: Ie(t + 4),
            code: ""
        }, u === 2 && (t.code = so(o + 8)), e = B(e).createShaderModule(t), fe[n >>> 0] = e;
    }
    var Vu = (e)=>{
    ...
    function Hu(e, t, n, o) {
        if (t = ue(t), o >>>= 0, n >>>= 0) {
            var u = {
                featureLevel: Iu[(d(), I)[n + 4 >>> 2 >>> 0]],
                powerPreference: Lu[(d(), I)[n + 8 >>> 2 >>> 0]],
                forceFallbackAdapter: !!(d(), E)[n + 12 >>> 2 >>> 0]
            };
    ...
    function ef(e, t) {
        if (e >>>= 0, t >>>= 0) {
            ...
            n = {
                label: n,
                timestampWrites: t = (t = (d(), E)[t + 12 >>> 2 >>> 0]) !== 0 ? {
                    querySet: B((d(), E)[t + 4 >>> 2 >>> 0]),
                    beginningOfPassWriteIndex: (d(), E)[t + 8 >>> 2 >>> 0],
                    endOfPassWriteIndex: (d(), E)[t + 12 >>> 2 >>> 0]
                } : void 0
            };
        }
    ...
    function lf(e, t) {
        ...
        e >>>= 0, t = {
            label: Ie((t >>>= 0) + 4),
            layout: B((d(), E)[t + 12 >>> 2 >>> 0]),
            entries: function(u, c) {
                for(var h = [], m = 0; m < u; ++m)h.push(n(c + 40 * m));
                return h;
            }((d(), E)[t + 16 >>> 2 >>> 0], (d(), E)[t + 20 >>> 2 >>> 0])
        }, e = B(e);
        var o = xo(0);
    ...
    function pf(e, t) {
        function n(y) {
            ...
            if (x) return {
                type: xu[x],
                hasDynamicOffset: !!(d(), E)[y + 8 >>> 2 >>> 0],
                minBindingSize: mt(y + 16)
            };
        }
        function o(y) {
            if (y = (d(), E)[y + 4 >>> 2 >>> 0]) return {
                type: Ou[y]
            };
        }
        function u(y) {
            ...
            if (x) return {
                sampleType: Du[x],
                viewDimension: co[(d(), I)[y + 8 >>> 2 >>> 0]],
                multisampled: !!(d(), E)[y + 12 >>> 2 >>> 0]
            };
        }
        function c(y) {
            var x = (d(), E)[y + 4 >>> 2 >>> 0];
            if (x) return {
                access: Mu[x],
                format: Cu[(d(), I)[y + 8 >>> 2 >>> 0]],
                viewDimension: co[(d(), I)[y + 12 >>> 2 >>> 0]]
            };
        }
        function h(y) {
            var x = {
                binding: (d(), E)[y + 4 >>> 2 >>> 0],
                visibility: (d(), E)[y + 8 >>> 2 >>> 0],
                buffer: n(y + 24),
                sampler: o(y + 48),
                texture: u(y + 56),
                storageTexture: c(y + 72)
            };
            return Ur(y, {
                13: ()=>{
                    x.externalTexture = {};
        ...
        e >>>= 0, t = {
            label: Ie((t >>>= 0) + 4),
            entries: function(y, x) {
                for(var N = [], F = 0; F < y; ++F)N.push(h(x + 88 * F));
                return N;
            }((d(), E)[t + 12 >>> 2 >>> 0], (d(), E)[t + 16 >>> 2 >>> 0])
        }, e = B(e);
        var m = Ao(0);
    ...
    function mf(e, t) {
        ...
        return e >>>= 0, (t >>>= 0) && (n = {
            label: Ie(t + 4)
        }), t = B(e), e = Lo(0), n = t.createCommandEncoder(n), fe[e >>> 0] = n, e;
    }
    function hf(e, t) {
        e >>>= 0, t >>>= 0;
        ...
        return t = {
            label: Ie(t + 4),
            bindGroupLayouts: u,
            immediateSize: (d(), E)[t + 20 >>> 2 >>> 0]
        }, n = B(e), e = Oo(0), t = n.createPipelineLayout(t), fe[e >>> 0] = t, e;
    }
    function bf(e, t) {
        e >>>= 0, t >>>= 0, t = {
            type: Bu[(d(), I)[t + 12 >>> 2 >>> 0]],
            count: (d(), E)[t + 16 >>> 2 >>> 0]
        };
        var n = B(e);
    ...
    i || function() {
        ...
        xe.push(async ()=>{
            var t = async function() {
                if (!i) return Promise.all(ke.map(Tn));
            }();
            Be++, await t, --Be == 0 && re && (t = re, re = null, t());
        });
    }(), i || (Fe = new WebAssembly.Memory({
        initial: 256,
        maximum: 65536,
        shared: !0
    }), se()), r.wasmBinary && (v = r.wasmBinary), r.stackSave = ()=>P(), r.stackRestore = (e)=>D(e), r.stackAlloc = (e)=>Vt(e), r.setValue = function(e, t, n = "i8") {
    ...
    var To, vo, Eo, Nr, zt, ve, Ke, So, xo, Ao, Io, Lo, Bo, Oo, Mo, Co, Do, Po, Wr, kr, Fr, Gr, St, $r, Uo, zr, _o, Ro, No, Vr, Wo, ko, jr, W, xt, Fo, D, Vt, P, Go, Hr, $o, zo, Vo, qr, jo, Ho, qo, Yo, Jo, Xo, Zo, Ko, Qo, ea, ta, ra, na, oa, aa, sa, ia, ua, fa, ca, da, la, pa, ma, ha, ba, ga, ya, wa, Ta, va, Ea, Sa, xa, Aa, Ia, La, Ba, Oa, Ma, Ca, Ne, xf = [
        Ye,
        Tr,
        xn,
        On,
        ...
        1281411: ()=>typeof wasmOffsetConverter < "u"
    };
    function Af() {
    ...
    function jt() {
        if (0 < Be) re = jt;
            ...
            0 < Be ? re = jt : (r.calledRun = !0, $ || (wr(), C?.(r)));
        }
    }
    return i || (Ne = await wt(), jt()), r.PTR_SIZE = 4, r.webgpuInit = (e)=>{
        ...
        r.webgpuRegisterBuffer = (m, y, x)=>{
            ...
            return y = ((N, F = 0)=>(N.mapState === "unmapped" || we(), F = Co(F), fe[F >>> 0] = N, F))(m, y), m[h] = [
                y,
                1
            ], y;
            ...
            return async ()=>{
                let L = N.createBuffer({
                    size: F,
                    usage: 9
                });
                try {
                    let q = N.createCommandEncoder();
                    return q.copyBufferToBuffer(m, 0, L, 0, F), N.queue.submit([
                        q.finish()
                    ]), await L.mapAsync(GPUMapMode.READ), L.getMappedRange().slice(0, y);
                } finally{
                    L.destroy();
                }
            };
            ...
            let q = (L = n.createBuffer({
                mappedAtCreation: !0,
                size: y,
                usage: 6
            })).getMappedRange();
            new Uint8Array(q).set(new Uint8Array(x, N, F)), L.unmap(), (x = n.createCommandEncoder()).copyBufferToBuffer(L, 0, m, 0, y), n.queue.submit([
                x.finish()
            ]), L.destroy();
        };
    }, r.webnnInit = (e)=>{
...
var gs, an, Tc, ye, ys, on, vc, Ec, ws, Sc, hs, Ts, bs, vs, Zt = G(()=>{
    "use strict";
    Xt();
    gs = typeof location > "u" ? void 0 : location.origin, an = __TURBOPACK__import$2e$meta__.url > "file:" && __TURBOPACK__import$2e$meta__.url < "file;", Tc = ()=>{
        if ("TURBOPACK compile-time truthy", 1) {
            if (an) {
                let a1 = URL;
                return new URL(new __turbopack_context__.U(__turbopack_context__.r("[project]/node_modules/onnxruntime-web/dist/ort.webgpu.bundle.min.mjs (static in ecmascript, tag client)")).href, gs).href;
            }
        ...
        try {
            let s = r ?? ye;
            return (s ? new URL(a1, s) : new URL(a1)).origin === gs;
        } catch  {
            return !1;
        }
    }, vc = (a1, r)=>{
    ...
    }, Ec = (a1, r)=>`${r ?? "./"}${a1}`, ws = async (a1)=>{
        let s = await (await fetch(a1, {
            credentials: "same-origin"
        })).blob();
        return URL.createObjectURL(s);
    }, Sc = async (a1)=>(await import(/*webpackIgnore:true*/ /*@vite-ignore*/ a1)).default, hs = (ds(), Ht(cs)).default, Ts = async ()=>{
    ...
    }, bs = (ms(), Ht(ps)).default, vs = async (a1, r, s, f)=>{
        let i = bs && !(a1 || r);
        ...
        {
            let p = "ort-wasm-simd-threaded.asyncify.mjs", l = a1 ?? vc(p, r), b = !!1 && s && l && !on(l, r), g = b ? await ws(l) : l ?? Ec(p, r);
            return [
                b ? g : void 0,
                await Sc(g)
            ];
...
var sn, un, sr, Es, xc, Ac, Ic, Kt, j, je = G(()=>{
    "use strict";
    Zt();
    un = !1, sr = !1, Es = !1, xc = ()=>{
        ...
        sr = !0;
        let r = a1.initTimeout, s = a1.numThreads;
        if (a1.simd !== !1) {
            if (a1.simd === "relaxed") {
        ...
        let i = a1.wasmPaths, p = typeof i == "string" ? i : void 0, l = i?.mjs, b = l?.href ?? l, g = i?.wasm, w = g?.href ?? g, S = a1.wasmBinary, [v, T] = await vs(b, p, s > 1, !!S || !!w), A = !1, C = [];
        if (r > 0 && C.push(new Promise((_)=>{
            ...
            T(U).then((M)=>{
                sr = !1, un = !0, sn = M, _(), v && URL.revokeObjectURL(v);
            }, (M)=>{
                sr = !1, Es = !0, k(M);
            });
...
var be, Bt, V, ir = G(()=>{
    ...
    je();
    be = (a1, r)=>{
        let s = j(), f = s.lengthBytesUTF8(a1) + 1, i = s._malloc(f);
        return s.stringToUTF8(a1, i, f), r.push(i), i;
    }, Bt = (a1, r, s, f)=>{
        if (typeof a1 == "object" && a1 !== null) {
            if (s.has(a1)) throw new Error("Circular reference in options");
            s.add(a1);
        }
        Object.entries(a1).forEach(([i, p])=>{
            let l = r ? r + i : i;
        ...
        try {
            ...
            throw new Error(`${a1} ERROR_CODE: ${p}, ERROR_MESSAGE: ${b}`);
        } finally{
            r.stackRestore(s);
        }
    };
...
var Ss, xs = G(()=>{
    ...
    Ss = (a1)=>{
        let r = j(), s = 0, f = [], i = a1 || {};
        try {
            if (a1?.logSeverityLevel === void 0) i.logSeverityLevel = 2;
            ...
            if (a1?.logVerbosityLevel === void 0) i.logVerbosityLevel = 0;
            ...
            a1?.terminate === void 0 && (i.terminate = !1);
            let p = 0;
            return a1?.tag !== void 0 && (p = be(a1.tag, f)), s = r._OrtCreateRunOptions(i.logSeverityLevel, i.logVerbosityLevel, !!i.terminate, p), s === 0 && V("Can't create run options."), a1?.extra !== void 0 && Bt(a1.extra, "", new WeakSet, (l, b)=>{
...
var Lc, Bc, Oc, Ot, We, Mc, As, Is = G(()=>{
    ...
    Lc = (a1)=>{
        ...
        let r = a1.extra.session;
        r.use_ort_model_bytes_directly || (r.use_ort_model_bytes_directly = "1"), a1.executionProviders && a1.executionProviders.some((s)=>(typeof s == "string" ? s : s.name) === "webgpu") && (a1.enableMemPattern = !1);
    }, Ot = (a1, r, s, f)=>{
        let i = be(r, f), p = be(s, f);
        j()._OrtAddSessionConfigEntry(a1, i, p) !== 0 && V(`Can't set a session config entry: ${r} - ${s}.`);
    }, We = (a1, r, s, f)=>{
        let i = be(r, f), p = be(s, f);
        a1.push([
            i,
        ...
        for (let i of f){
            ...
            switch(p){
                case "webnn":
                    if (p = "WEBNN", Ot(a1, "session.disable_quant_qdq", "1", s), Ot(a1, "session.disable_qdq_constant_folding", "1", s), typeof i != "string") {
                        let T = i?.deviceType;
                        T && Ot(a1, "deviceType", T, s);
                    }
                    break;
                case "webgpu":
                    {
                        ...
                        if (typeof i != "string") {
                            ...
                            if (typeof C == "boolean" && C && We(l, "enableGraphCapture", "1", s), typeof A.preferredLayout == "string" && We(l, "preferredLayout", A.preferredLayout, s), A.forceCpuNodeNames) {
                                let _ = Array.isArray(A.forceCpuNodeNames) ? A.forceCpuNodeNames : [
                                    A.forceCpuNodeNames
                                ];
                                We(l, "forceCpuNodeNames", _.join(`
`), s);
                            }
                            A.validationMode && We(l, "validationMode", A.validationMode, s), typeof A.enableMatmulFp32Accumulation == "boolean" && We(l, "enableMatmulFp32Accumulation", A.enableMatmulFp32Accumulation ? "1" : "0", s);
                            for (let _ of [
                        ...
                        if (T) {
                            let [A, C, _] = T;
                            We(l, "deviceId", A.toString(), s), We(l, "webgpuInstance", C.toString(), s), We(l, "webgpuDevice", _.toString(), s);
                        }
                    }
                    break;
                case "wasm":
            ...
            await j()._OrtAppendExecutionProvider(a1, b, w, S, g) !== 0 && V(`Can't append execution provider: ${p}.`);
        }
    }, As = async (a1)=>{
        let r = j(), s = 0, f = [], i = a1 || {};
        Oc(i);
        try {
            ...
            return i.extra !== void 0 && Bt(i.extra, "", new WeakSet, (v, T)=>{
                Ot(s, v, T, f);
            }), [
                s,
                f
...
var He, ur, bt, it, Mt, fr, cr, fn, ut = G(()=>{
    "use strict";
    He = (a1)=>{
        switch(a1){
            case "int8":
        ...
        let s = [
            ...
            .5,
            .5
        ][a1], f = typeof r == "number" ? r : r.reduce((i, p)=>i * p, 1);
    ...
    }, fr = (a1)=>a1 === "float32" || a1 === "float16" || a1 === "int32" || a1 === "int64" || a1 === "uint32" || a1 === "uint8" || a1 === "bool" || a1 === "uint4" || a1 === "int4", cr = (a1)=>a1 === "float32" || a1 === "float16" || a1 === "int32" || a1 === "int64" || a1 === "uint32" || a1 === "uint64" || a1 === "int8" || a1 === "uint8" || a1 === "bool" || a1 === "uint4" || a1 === "int4", fn = (a1)=>{
        switch(a1){
            case "none":
                return 0;
            case "cpu":
...
var Ct, cn = G(()=>{
    ...
    Ct = async (a1)=>{
        ...
        ;
            ...
            let r = await fetch(a1);
            if (!r.ok) throw new Error(`failed to load external data file: ${a1}`);
            let s = r.headers.get("Content-Length"), f = s ? parseInt(s, 10) : 0;
            if (f < 1073741824) return new Uint8Array(await r.arrayBuffer());
            {
                if (!r.body) throw new Error(`failed to load external data file: ${a1}, no response body.`);
...
var Cc, Dc, Os, Ms, Cs, Pc, le, dn = G(()=>{
    ...
    Cc = [
        ...
        console.log(`[${Cc[a1]},${new Date().toISOString()}]${r}`);
    }, Cs = (a1, r)=>{
        Os = a1, Ms = r;
    }, Pc = (a1, r)=>{
        let s = Mt(a1), f = Mt(Os);
...
var Ps, Uc, Us, _c, Ds, Rc, _s, dr, lr, ln, Rs, Ns = G(()=>{
    "use strict";
    ut();
    dn();
    Ps = new Map([
        ...
        if (r === "int32") return a1;
        let s = Ps.get(r);
        if (!s) throw new Error(`WebNN backend does not support data type: ${r}`);
        let f = s / 8;
        if (a1.byteLength % f !== 0) throw new Error(`Invalid Uint8Array length - must be a multiple of ${f}.`);
        let i = a1.byteLength / f, p = new (it(r))(a1.buffer, a1.byteOffset, i);
        switch(r){
            case "int64":
            case "uint64":
                {
        ...
        let s = a1.byteLength / 4, f = new Int32Array(a1.buffer, a1.byteOffset, s);
        switch(r){
            case "int64":
                {
        ...
        async ensureTensor(r, s, f, i) {
            ...
            return this.wrapper = await this.tensorManager.getCachedTensor(r, s, f, g, !0, !0, b), i && this.activeUpload && (this.wrapper.write(this.activeUpload), this.activeUpload = void 0), this.wrapper.tensor;
        }
        upload(r) {
            let s = r;
            if (this.wrapper) {
                if (this.wrapper.fallbackType) if (this.wrapper.fallbackType === "int32") s = Uc(r, this.wrapper.type), this.wrapper.setIsDataConverted(!0);
        ...
        registerTensor(r, s, f, i) {
            let p = this.getMLContext(r), l = Ds(), b = new dr({
                sessionId: r,
                context: p,
                tensor: s,
                dataType: f,
...
var pr, Nc, pn, ks = G(()=>{
    ...
    pr = new Map([
        ...
        if (a1 === r) return !0;
        if (a1 === void 0 || r === void 0) return !1;
        let s = Object.keys(a1).sort(), f = Object.keys(r).sort();
        return s.length === f.length && s.every((i, p)=>i === f[p] && a1[i] === r[i]);
    }, pn = class {
        constructor(r){
        ...
        async createTemporaryTensor(r, s, f) {
            ...
            await this.tensorManager.ensureTensor(r, p, i, f, !1);
            let l = this.temporarySessionTensorIds.get(r);
            return l ? l.push(p) : this.temporarySessionTensorIds.set(r, [
                p
            ]), p;
        }
        uploadTensor(r, s) {
        ...
        isGraphInputOutputTypeSupported(r, s, f = !0) {
            ...
            return typeof i > "u" ? !1 : f ? !!p?.input.dataTypes.includes(i) : !!p?.output.dataTypes.includes(i);
        }
        flush() {}
    };
});
var Wc, Qt, er, ft, kc, Fs, Lt, tr, rr, Gs, nr, or, ar, nn = G(()=>{
    "use strict";
    Ve();
    xs();
    Is();
    ...
    cn();
    Wc = (a1, r)=>{
        j()._OrtInit(a1, r) !== 0 && V("Can't initialize onnxruntime.");
    }, Qt = async (a1)=>{
        Wc(a1.wasm.numThreads, Mt(a1.logLevel));
    }, er = async (a1, r)=>{
        j().asyncInit?.();
        ...
        if (r === "webgpu" && j().webgpuInit((f)=>{
            ...
            let f = new (ks(), Ht(Ws)).WebNNBackend(a1);
            j().webnnInit([
                f,
                ()=>f.reserveTensorId(),
                (i)=>f.releaseTensorId(i),
                async (i, p, l, b, g)=>f.ensureTensor(i, p, l, b, g),
                (i, p)=>{
                    f.uploadTensor(i, p);
                },
                async (i, p)=>f.downloadTensor(i, p),
                (i, p)=>f.registerMLContext(i, p),
                !!a1.trace
            ]);
        }
    }, ft = new Map, kc = (a1)=>{
        ...
        try {
            let f = r.PTR_SIZE, i = r.stackAlloc(2 * f);
            r._OrtGetInputOutputCount(a1, i, i + f) !== 0 && V("Can't get session input/output count.");
            let l = f === 4 ? "i32" : "i64";
            return [
                Number(r.getValue(i, l)),
                Number(r.getValue(i + f, l))
            ];
        } finally{
            r.stackRestore(s);
        }
        ...
        try {
            ...
            s._OrtGetInputOutputMetadata(a1, r, l, l + p) !== 0 && V("Can't get session input/output metadata.");
        ...
        let r = j(), s = r._malloc(a1.byteLength);
        if (s === 0) throw new Error(`Can't create a session. failed to allocate a buffer of size ${a1.byteLength}.`);
        return r.HEAPU8.set(a1, s), [
            s,
            a1.byteLength
        ];
    }, tr = async (a1, r)=>{
        let s, f, i = j();
        Array.isArray(a1) ? [s, f] = a1 : a1.buffer === i.HEAPU8.buffer ? [s, f] = [
            a1.byteOffset,
            a1.byteLength
        ] : [s, f] = Lt(a1);
        ...
        try {
            ...
            for (let O of r?.executionProviders ?? [])if ((typeof O == "string" ? O : O.name) === "webnn") {
                if (i.shouldTransferToMLTensor = !1, typeof O != "string") {
                    let oe = O, d = oe?.context, te = oe?.gpuDevice, Z = oe?.deviceType, X = oe?.powerPreference;
                    d ? i.currentContext = d : te ? i.currentContext = await i.webnnCreateMLContext(te) : i.currentContext = await i.webnnCreateMLContext({
                        deviceType: Z,
                        powerPreference: X
                    });
            ...
            p = await i._OrtCreateSession(s, f, l), i.webgpuOnCreateSession?.(p), p === 0 && V("Can't create a session."), i.jsepOnCreateSession?.(), i.currentContext && (i.webnnRegisterMLContext(p, i.currentContext), i.currentContext = void 0, i.shouldTransferToMLTensor = !0);
            let [v, T] = kc(p), A = !!r?.enableGraphCapture, C = [], _ = [], k = [], U = [], M = [];
            for(let O = 0; O < v; O++){
                let [$, oe, d] = Fs(p, O);
                $ === 0 && V("Can't get an input name."), w.push($);
                let te = i.UTF8ToString($);
                C.push(te), k.push(oe === 0 ? {
                    name: te,
                    isTensor: !1
                } : {
                    name: te,
            ...
            let Y = null;
            return M.some((O)=>O === "gpu-buffer" || O === "ml-tensor" || O === "ml-tensor-cpu-output") && (b = i._OrtCreateBinding(p), b === 0 && V("Can't create IO binding."), Y = {
                handle: b,
                outputPreferredLocations: M,
                outputPreferredLocationsEncoded: M.map((O)=>O === "ml-tensor-cpu-output" ? "ml-tensor" : O).map((O)=>fn(O))
            }), ft.set(p, [
                p,
                w,
                S,
        ...
        let [f, i, p, l, b] = s;
        l && (b && r._OrtClearBoundOutputs(l.handle) !== 0 && V("Can't clear bound outputs."), r._OrtReleaseBinding(l.handle) !== 0 && V("Can't release IO binding.")), r.jsepOnReleaseSession?.(a1), r.webnnOnReleaseSession?.(a1), r.webgpuOnReleaseSession?.(a1), i.forEach((g)=>r._OrtFree(g)), p.forEach((g)=>r._OrtFree(g)), r._OrtReleaseSession(f) !== 0 && V("Can't release session."), ft.delete(a1);
    }, Gs = async (a1, r, s, f, i, p, l = !1)=>{
        if (!a1) {
            r.push(0);
            return;
        }
        let b = j(), g = b.PTR_SIZE, w = a1[0], S = a1[1], v = a1[3], T = v, A, C;
    ...
    }, nr = async (a1, r, s, f, i, p)=>{
        let l = j(), b = l.PTR_SIZE, g = ft.get(a1);
        if (!g) throw new Error(`cannot run inference. invalid session id: ${a1}`);
        ...
        try {
            [U, M] = Ss(p), $e("wasm prepareInputOutputTensor");
            for(let R = 0; R < _; R++)await Gs(s[R], Y, $, a1, S[r[R]], r[R], A);
            for(let R = 0; R < k; R++)await Gs(i[R], O, $, a1, v[f[R]], _ + f[R], A);
            ...
            if (T && !C) {
                ...
                for(let J = 0; J < _; J++){
                    let ge = r[J];
                    await l._OrtBindInput(R, S[ge], Y[J]) !== 0 && V(`Can't bind input[${J}] for session=${a1}.`);
                }
                for(let J = 0; J < k; J++){
                    let ge = f[J];
                    i[J]?.[3] ? (oe.push(O[J]), l._OrtBindOutput(R, v[ge], O[J], 0) !== 0 && V(`Can't bind pre-allocated output[${J}] for session=${a1}.`)) : l._OrtBindOutput(R, v[ge], 0, pe[ge]) !== 0 && V(`Can't bind output[${J}] to ${ae[J]} for session=${a1}.`);
                }
                ze("wasm bindInputsOutputs"), ft.set(a1, [
                    w,
                    S,
                    v,
                    T,
            ...
            for(let R = 0; R < k; R++){
                ...
                let pe = l.stackSave(), J = l.stackAlloc(4 * b), ge = !1, ne, se = 0;
                try {
                    ...
                    if (ne === "string") {
                        ...
                        ge = !0;
                        {
                            l.webgpuRegisterBuffer(Q, a1, se);
                            let H = l.webgpuCreateDownloader(Q, z, a1);
                            I.push([
                                ne,
                                Se,
                                {
                        ...
                        if (!Q(a1, ne, !1)) throw new Error(`preferredLocation "ml-tensor" for ${ne} output is not supported by current WebNN Context.`);
                        let H = await re(a1, se, qe, Se, !1);
                        ge = !0, I.push([
                            ne,
                            Se,
                            {
                                mlTensor: H,
                                download: l.webnnCreateMLTensorDownloader(se, ne),
                                dispose: ()=>{
                        ...
                        new Uint8Array(Q.buffer, Q.byteOffset, Q.byteLength).set(l.HEAPU8.subarray(se, se + Q.byteLength)), I.push([
                            ne,
                            Se,
                            Q,
                            "cpu"
            ...
            T && !A && (l._OrtClearBoundOutputs(T.handle) !== 0 && V("Can't clear bound outputs."), ft.set(a1, [
                w,
                S,
                v,
                T,
            ...
            return ze("wasm ProcessOutputTensor"), I;
        } finally{
...
var ct, Ee, Dt, hr, br, mr, mn, hn, gt, yt, Gc, $s, zs, Vs, js, Hs, qs, Ys, bn = G(()=>{
    "use strict";
    Ve();
    nn();
    je();
    Zt();
    ct = ()=>!!ee.wasm.proxy && typeof document < "u", Dt = !1, hr = !1, br = !1, hn = new Map, gt = (a1, r)=>{
        let s = hn.get(a1);
        s ? s.push(r) : hn.set(a1, [
            r
        ]);
    }, yt = ()=>{
        ...
        switch(a1.data.type){
            case "init-wasm":
                Dt = !1, a1.data.err ? (br = !0, mn[1](a1.data.err)) : (hr = !0, mn[0]()), mr && (URL.revokeObjectURL(mr), mr = void 0);
                break;
            case "init-ep":
            case "copy-from":
            case "create":
            ...
            case "end-profiling":
                {
                    let r = hn.get(a1.data.type);
                    a1.data.err ? r.shift()[1](a1.data.err) : r.shift()[0](a1.data.out);
                    break;
                }
            default:
        }
        ...
        if (!hr) {
            ...
            if (Dt = !0, ct()) return new Promise((a1, r)=>{
                Ee?.terminate(), Ts().then(([s, f])=>{
                    try {
                        Ee = f, Ee.onerror = (p)=>r(p), Ee.onmessage = Gc, mn = [
                            a1,
                            r
                        ];
                        let i = {
                        ...
                        !i.in.wasm.wasmPaths && (s || an) && (i.in.wasm.wasmPaths = {
                            wasm: new __turbopack_context__.U(__turbopack_context__.r("[project]/node_modules/onnxruntime-web/dist/ort-wasm-simd-threaded.asyncify.wasm (static in ecmascript, tag client)")).href
                        }), Ee.postMessage(i), mr = s;
                    } catch (i) {
                        r(i);
                    }
                }, r);
            ...
            try {
                await Kt(ee.wasm), await Qt(ee), hr = !0;
            } catch (a1) {
                throw br = !0, a1;
            } finally{
                Dt = !1;
        ...
        await er(ee, a1);
    }, Vs = async (a1)=>ct() ? (yt(), new Promise((r, s)=>{
            gt("copy-from", [
                r,
                s
            ]);
        ...
        if (ct()) {
            ...
            return yt(), new Promise((s, f)=>{
                ...
                a1 instanceof Uint8Array && p.push(a1.buffer), Ee.postMessage(i, p);
            });
        } else return tr(a1, r);
    }, Hs = async (a1)=>{
        if (ct()) return yt(), new Promise((r, s)=>{
...
var Js, $c, gr, Xs = G(()=>{
    ...
    Js = (a1, r)=>{
        switch(a1.location){
            ...
            default:
                throw new Error(`invalid data location: ${a1.location} for ${r()}`);
        }
    }, $c = (a1)=>{
        switch(a1[3]){
            case "cpu":
                return new Le(a1[0], a1[2], a1[1]);
            case "gpu-buffer":
                {
                    let r = a1[0];
                    if (!fr(r)) throw new Error(`not supported data type: ${r} for deserializing GPU tensor`);
                    let { gpuBuffer: s, download: f, dispose: i } = a1[2];
                    return Le.fromGpuBuffer(s, {
                        dataType: r,
                        dims: a1[1],
                        download: f,
                        dispose: i
            ...
            case "ml-tensor":
                {
                    ...
                    let { mlTensor: s, download: f, dispose: i } = a1[2];
                    return Le.fromMLTensor(s, {
                        dataType: r,
                        dims: a1[1],
                        download: f,
                        dispose: i
...
var Ks = {};
At(Ks, {
    OnnxruntimeWebAssemblyBackend: ()=>yr,
    initializeFlags: ()=>Zs,
    wasmBackend: ()=>zc
});
var Zs, yr, zc, Qs = G(()=>{
    ...
    Zs = ()=>{
        ...
        let a1 = ee.wasm.simd;
        if (typeof a1 != "boolean" && a1 !== void 0 && a1 !== "fixed" && a1 !== "relaxed" && (console.warn(`Property "env.wasm.simd" is set to unknown value "${a1}". Reset it to \`false\` and ignore SIMD feature checking.`), ee.wasm.simd = !1), typeof ee.wasm.proxy != "boolean" && (ee.wasm.proxy = !1), typeof ee.wasm.trace != "boolean" && (ee.wasm.trace = !1), typeof ee.wasm.numThreads != "number" || !Number.isInteger(ee.wasm.numThreads) || ee.wasm.numThreads <= 0) if (typeof self < "u" && !self.crossOriginIsolated) ee.wasm.numThreads = 1;
        else {
...
Ve();
Ve();
var is = "1.31.0-dev.20260914-8d85527a0";
var $l = rn;
{
    let a1 = (Qs(), Ht(Ks)).wasmBackend;
    rt("webgpu", a1, 5), rt("webnn", a1, 5), rt("cpu", a1, 10), rt("wasm", a1, 10);
}Object.defineProperty(ee.versions, "web", {
    value: is,
    enumerable: !0
});
;
...
//# sourceMappingURL=node_modules_onnxruntime-web_dist_20xkdlb._.js.map
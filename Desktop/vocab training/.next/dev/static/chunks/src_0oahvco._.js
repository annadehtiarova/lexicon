...
"[project]/src/app/sets/[id]/page.tsx [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
function StudySetPage({ params }) {
    ...
    const words = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useMemo"])({
        "StudySetPage.useMemo[words]": ()=>{
            const usedExamples = new Set();
            return (set?.words ?? []).map({
                "StudySetPage.useMemo[words]": (word, index)=>{
                    const normalized = {
                        ...word,
    ...
    const handleMastered = (wordId)=>{
        setMasteredIds((prev)=>{
            ...
            if (set.isPersisted) (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$storage$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["setMasteredWordIds"])(id, Array.from(next));
            return next;
        });
    };
...
_s(StudySetPage, "9jgV2gl+/YzlmTetkErwReTwMZQ=");
_c = StudySetPage;
var _c;
__turbopack_context__.k.register(_c, "StudySetPage");
...
//# sourceMappingURL=src_0oahvco._.js.map